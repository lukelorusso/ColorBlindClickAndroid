...
class GetColorUseCase(private val repository: ColorRepository) : SingleUseCase<Color, GetColorUseCase.Param>() {

    override fun build(param: Param): Single<Color> =
        repository.getColor(param.colorHash, param.deviceUdid)
